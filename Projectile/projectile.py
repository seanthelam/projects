...
GRAPH_SIZE = (600, 600)
win = pygame.display.set_mode(GRAPH_SIZE, pygame.NOFRAME)
...
u = 10 # velocity in m/s
u_change = 0.1 # amount by which velocity changes
u_min = 1 # min velocity in m/s
u_max = 12.4 # max velocity in m/s
...
while running:
    ...
    pygame.draw.line(win, YELLOW, origin, (origin[0] + 250, origin[1]), 2)
    pygame.draw.line(win, BLUE, origin, (origin[0], origin[1] - 250), 2)
    ...
    # Info *******************************************************************
    title = font.render("Projectile Motion of Long Jump", True, WHITE)
